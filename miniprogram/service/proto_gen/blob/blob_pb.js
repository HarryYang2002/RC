...
export const blob = $root.blob = (() => {
    ...
    blob.v1 = (function() {
        ...
        v1.CreateBlobRequest = (function() {
             ...
             * @constructor
             * @param {blob.v1.ICreateBlobRequest=} [properties] Properties to set
             */
             ...
             * @memberof blob.v1.CreateBlobRequest
             * @instance
             */
             ...
             * @returns {blob.v1.CreateBlobRequest} CreateBlobRequest
             */
            CreateBlobRequest.fromObject = function fromObject(object) {
                if (object instanceof $root.blob.v1.CreateBlobRequest)
                    return object;
                let message = new $root.blob.v1.CreateBlobRequest();
             ...
             * @memberof blob.v1.CreateBlobRequest
             * @static
             * @param {blob.v1.CreateBlobRequest} message CreateBlobRequest
        ...
        v1.CreateBlobResponse = (function() {
             ...
             * @constructor
             * @param {blob.v1.ICreateBlobResponse=} [properties] Properties to set
             */
             ...
             * @member {string} id
             * @memberof blob.v1.CreateBlobResponse
             * @instance
             */
             ...
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {blob.v1.CreateBlobResponse} CreateBlobResponse
             */
            CreateBlobResponse.fromObject = function fromObject(object) {
                if (object instanceof $root.blob.v1.CreateBlobResponse)
                    return object;
                let message = new $root.blob.v1.CreateBlobResponse();
                if (object.id != null)
             ...
             * @memberof blob.v1.CreateBlobResponse
             * @static
             * @param {blob.v1.CreateBlobResponse} message CreateBlobResponse
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
        ...
        v1.GetBlobRequest = (function() {
             ...
             * @constructor
             * @param {blob.v1.IGetBlobRequest=} [properties] Properties to set
             */
             ...
             * GetBlobRequest id.
             * @member {string} id
             * @memberof blob.v1.GetBlobRequest
             * @instance
             */
             ...
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {blob.v1.GetBlobRequest} GetBlobRequest
             */
            GetBlobRequest.fromObject = function fromObject(object) {
                if (object instanceof $root.blob.v1.GetBlobRequest)
                    return object;
                let message = new $root.blob.v1.GetBlobRequest();
                if (object.id != null)
                    message.id = String(object.id);
                return message;
            };
             ...
             * @memberof blob.v1.GetBlobRequest
             * @static
             * @param {blob.v1.GetBlobRequest} message GetBlobRequest
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
        ...
        v1.GetBlobResponse = (function() {
             ...
             * @constructor
             * @param {blob.v1.IGetBlobResponse=} [properties] Properties to set
             */
             ...
             * @memberof blob.v1.GetBlobResponse
             * @instance
             */
             ...
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {blob.v1.GetBlobResponse} GetBlobResponse
             */
            GetBlobResponse.fromObject = function fromObject(object) {
                if (object instanceof $root.blob.v1.GetBlobResponse)
                    return object;
                let message = new $root.blob.v1.GetBlobResponse();
                if (object.data != null)
             ...
             * @memberof blob.v1.GetBlobResponse
             * @static
             * @param {blob.v1.GetBlobResponse} message GetBlobResponse
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
        ...
        v1.GetBlobURLRequest = (function() {
             ...
             * @constructor
             * @param {blob.v1.IGetBlobURLRequest=} [properties] Properties to set
             */
             ...
             * @member {string} id
             * @memberof blob.v1.GetBlobURLRequest
             * @instance
             */
             ...
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {blob.v1.GetBlobURLRequest} GetBlobURLRequest
             */
            GetBlobURLRequest.fromObject = function fromObject(object) {
                if (object instanceof $root.blob.v1.GetBlobURLRequest)
                    return object;
                let message = new $root.blob.v1.GetBlobURLRequest();
                if (object.id != null)
                    message.id = String(object.id);
             ...
             * @memberof blob.v1.GetBlobURLRequest
             * @static
             * @param {blob.v1.GetBlobURLRequest} message GetBlobURLRequest
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
        ...
        v1.GetBlobURLResponse = (function() {
             ...
             * @constructor
             * @param {blob.v1.IGetBlobURLResponse=} [properties] Properties to set
             */
             ...
             * @member {string} url
             * @memberof blob.v1.GetBlobURLResponse
             * @instance
             */
             ...
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {blob.v1.GetBlobURLResponse} GetBlobURLResponse
             */
            GetBlobURLResponse.fromObject = function fromObject(object) {
                if (object instanceof $root.blob.v1.GetBlobURLResponse)
                    return object;
                let message = new $root.blob.v1.GetBlobURLResponse();
                if (object.url != null)
             ...
             * @memberof blob.v1.GetBlobURLResponse
             * @static
             * @param {blob.v1.GetBlobURLResponse} message GetBlobURLResponse
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
        ...
        v1.BlobService = (function() {
             ...
             * @memberof blob.v1.BlobService
             * @typedef CreateBlobCallback
             * @type {function}
             * @param {Error|null} error Error, if any
             * @param {blob.v1.CreateBlobResponse} [response] CreateBlobResponse
             */
             ...
             * @memberof blob.v1.BlobService
             * @instance
             * @param {blob.v1.ICreateBlobRequest} request CreateBlobRequest message or plain object
             * @param {blob.v1.BlobService.CreateBlobCallback} callback Node-style callback called with the error, if any, and CreateBlobResponse
             * @returns {undefined}
             * @variation 1
             */
            Object.defineProperty(BlobService.prototype.createBlob = function createBlob(request, callback) {
                return this.rpcCall(createBlob, $root.blob.v1.CreateBlobRequest, $root.blob.v1.CreateBlobResponse, request, callback);
             ...
             * @instance
             * @param {blob.v1.ICreateBlobRequest} request CreateBlobRequest message or plain object
             * @returns {Promise<blob.v1.CreateBlobResponse>} Promise
             * @variation 2
             */
             ...
             * @type {function}
             * @param {Error|null} error Error, if any
             * @param {blob.v1.GetBlobResponse} [response] GetBlobResponse
             */
             ...
             * @memberof blob.v1.BlobService
             * @instance
             * @param {blob.v1.IGetBlobRequest} request GetBlobRequest message or plain object
             * @param {blob.v1.BlobService.GetBlobCallback} callback Node-style callback called with the error, if any, and GetBlobResponse
             * @returns {undefined}
             * @variation 1
             */
            Object.defineProperty(BlobService.prototype.getBlob = function getBlob(request, callback) {
                return this.rpcCall(getBlob, $root.blob.v1.GetBlobRequest, $root.blob.v1.GetBlobResponse, request, callback);
            }, "name", { value: "GetBlob" });
             ...
             * @instance
             * @param {blob.v1.IGetBlobRequest} request GetBlobRequest message or plain object
             * @returns {Promise<blob.v1.GetBlobResponse>} Promise
             * @variation 2
             */
             ...
             * @type {function}
             * @param {Error|null} error Error, if any
             * @param {blob.v1.GetBlobURLResponse} [response] GetBlobURLResponse
             */
             ...
             * @memberof blob.v1.BlobService
             * @instance
             * @param {blob.v1.IGetBlobURLRequest} request GetBlobURLRequest message or plain object
             * @param {blob.v1.BlobService.GetBlobURLCallback} callback Node-style callback called with the error, if any, and GetBlobURLResponse
             * @returns {undefined}
             * @variation 1
             */
            Object.defineProperty(BlobService.prototype.getBlobURL = function getBlobURL(request, callback) {
                return this.rpcCall(getBlobURL, $root.blob.v1.GetBlobURLRequest, $root.blob.v1.GetBlobURLResponse, request, callback);
             ...
             * @instance
             * @param {blob.v1.IGetBlobURLRequest} request GetBlobURLRequest message or plain object
             * @returns {Promise<blob.v1.GetBlobURLResponse>} Promise
             * @variation 2
             */
